#!/bin/bash
# Run Pseudo Token + ST Gumbel-Softmax training inside Docker container (GPU 4-7)
...
echo "Running training in Docker container vlm-env..."
...
echo "Training finished. Check work_dirs/pseudo_gumbel_4gpu.log for details."
