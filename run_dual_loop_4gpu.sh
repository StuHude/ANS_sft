#!/bin/bash
# Run dual-loop training on GPU 4-7
...
torchrun --nproc_per_node=4 --master_port=29600 \
    ...
    --log_interval 10 \
    --save_interval 500 \
    2>&1 | tee work_dirs/dual_loop_sft_4gpu.log
