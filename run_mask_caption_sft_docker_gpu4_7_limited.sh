#!/bin/bash
#
# Run Mask Captioning SFT Training in Docker on GPU 4-7 with batch_size=4
# Limit SA1B to 1000 samples
#

echo "Starting training in Docker on GPU 4-7 with batch_size=4, SA1B limited to 1000 samples"
...
nohup torchrun --nproc_per_node=4 \
    ...
    --lora_r 128 \
    --lora_alpha 256 \
    > /data/xyc/ANS/work_dirs/mask_caption_training_gpu4_7.log 2>&1 &
"
